    ...
    return gameElements
        ...
        .factory('Monster', ['Global', 'StatusBar', 'Events', function (Global, StatusBar, Events) {
            ...
            p.get_hit_by_hero_end = function () {
                ...
                Global.game.hero_obj.hide(Global.game.hero_obj.endAttackSprite);
                ...
                if (isAnswerCorrect) {
                    ...
                    if (this.life_percentage === 0) {
                        ...
                        var flyout_path = [
                            150 / Global.game.scale_idx,
                            150 / Global.game.scale_idx,
                            400 / Global.game.scale_idx,
                            -200 / Global.game.scale_idx,
                            600 / Global.game.scale_idx,
                            120 / Global.game.scale_idx
                        ];

                        // animate monster dead and puff
                        var tween = createjs.Tween.get(this.deadSprite)
                        .to({ guide: { path: flyout_path }, rotation: 360 }, 1200)
            ...
            p.play_dead_out_and_puff = function(){
                ...
                createjs.Tween.get(this.puff_back)
            ...
            p.toggle_status_bar = function (action) {
                var tween = null;
                if (action === 'show') {
                    tween = createjs.Tween.get(this.hp_bar).to({ alpha: 1 }, 300);
                } else if(action === 'hide') {
                    tween = createjs.Tween.get(this.hp_bar).to({ alpha: 0 }, 300);
                }
            }
            ...
            Monster.prototype.dodge_animation_config = function () {
                ...
                var path_pos_1 = [
                    55,
                    20,
                    pivot[0] / Global.game.scale_idx - this.x,
                    pivot[1] / Global.game.scale_idx - this.y,
                    Global.game.hero_obj.breathingSprite.x + 200 * expend_scale - this.x,
                    Global.game.hero_obj.breathingSprite.y + 170 * expend_scale - this.y
                ];

                var path_pos_2 = [
                    Global.game.hero_obj.breathingSprite.x + 200 * expend_scale - this.x,
                    Global.game.hero_obj.breathingSprite.y + 170 * expend_scale - this.y,
                    pivot[2] / Global.game.scale_idx - this.x,
                    pivot[3] / Global.game.scale_idx - this.y,
                    Global.game.hero_obj.breathingSprite.x + 530 * fuck_scale - this.x,
                    Global.game.hero_obj.breathingSprite.y + 270 * 2.3 - this.y
                ];

                var path_pos_3 = [
                    Global.game.hero_obj.breathingSprite.x + 530 * fuck_scale - this.x,
                    Global.game.hero_obj.breathingSprite.y + 270 * 2.3 - this.y,
                    pivot[4] / Global.game.scale_idx - this.x,
                    pivot[5] / Global.game.scale_idx - this.y,
                    0,
                    this.breathingSprite.y
                ];
            ...
            p.dodge_animation_attack = function () {
                ...
                this.toggle_status_bar('hide');
                // hide ansewr box
                createjs.Tween.get(this.answer_box).to({ alpha: 0 }, 200);
            };
