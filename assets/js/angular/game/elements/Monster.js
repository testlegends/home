    ...
    return gameElements
        ...
        .factory('Monster', ['Global', 'StatusBar', 'Events', function (Global, StatusBar, Events) {
            ...
            p.return_to_original_pos = function(){
                ...
                .wait(200)
                .call(function(){
                    // incorect - recycle the questinos
                    Global.game.question.question_list.reverse();
                    Global.game.question.question_list.push(Global.game.question.current_question_text);
                    Global.game.question.question_list.reverse();
